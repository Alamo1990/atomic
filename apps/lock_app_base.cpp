...
void looper(int mode,
    int nitems,
    locked_buffer<pair<int, uchar_matrix > >*   queue1,
    locked_buffer<pair<int, complex_matrix > >* queue2,
    locked_buffer<pair<int, complex_matrix > >* queue3,
...
int main(int argc, char* argv[]){
        ...
        auto queue1 = new locked_buffer<pair<int,uchar_matrix   > >(buff_size);
        auto queue2 = new locked_buffer<pair<int,complex_matrix > >(buff_size);
        auto queue3 = new locked_buffer<pair<int,complex_matrix > >(buff_size);
        auto queue4 = new locked_buffer<pair<int,uchar_matrix   > >(buff_size);
